...
class ChocobosSegment extends React.Component {
  constructor() {
    super()
    this.skAccount = new Bond;
    this.skChoco1 = new Bond;
    this.skChoco2 = new Bond;
  }
    ...
    return <Segment style={{ margin: '1em' }} padded>
      <Header as='h2'>
          ...
          <Header.Content>
            Substrate Chocobos
            <Header.Subheader>
              There are <Pretty value={runtime.substratechocobos.allChocobosCount} /> chocobos. Kweh! Wark!
            </Header.Subheader>
          </Header.Content>
      </Header>
      <div style={{ paddingBottom: '1em' }}></div>
      ...
      <TransactButton
        content="Create Chocobo"
        icon='paw'
        tx={{
          sender: runtime.indices.tryIndex(this.skAccount),
          call: calls.substratechocobos.createChocobo()
        }}
      />
    </Segment>
  }
