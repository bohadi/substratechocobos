...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("substratechocobos"),
	impl_name: create_runtime_str!("substratechocobos"),
	authoring_version: 3,
	spec_version: 4,
	impl_version: 4,
...
impl substratechocobos::Trait for Runtime {
	type Event = Event;
}
...
construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic
	{
		...
		Sudo: sudo,
		// Used for the module template in `./template.rs`
		Substratechocobos: substratechocobos::{Module, Call, Storage, Event<T>},
